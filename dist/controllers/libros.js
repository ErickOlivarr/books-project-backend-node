...
exports.obtenerFavoritos = exports.añadirFavorito = exports.obtenerLibro = exports.obtenerLibros = exports.eliminarLibro = exports.actualizarLibro = exports.crearLibro = void 0;
...
const crearLibro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    req.body.nombre = (0, funciones_1.capitalizar)(nombre);
    ...
    try {
        ...
        const libroGuardado = yield libro_1.default.findById(libro.id)
        ...
        const autoresActualizados = yield autor_1.default.updateMany({
            _id: {
...
const actualizarLibro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body, { usuario } = _a, body = __rest(_a, ["usuario"]);
    const { id } = req.params;
    const { id: idLogueado } = req.payload;
    const session = yield mongoose_1.default.startSession();
    session.startTransaction();
    try {
        const libroActualizado = yield libro_1.default.findByIdAndUpdate(id, body, { new: true, session });
...
const eliminarLibro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    session.startTransaction();
    try {
        const libro = yield libro_1.default.findOneAndDelete({ _id: new objectId(id) }).session(session);
        yield autor_1.default.updateMany({
            _id: {
                $in: [...(libro.autores)]
            }
        }, {
...
const obtenerLibros = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //     }
    // ]);
    const auths = yield autor_1.default.find({
        $expr: {
            $regexMatch: {
                input: {
                    $concat: ['$nombre', ' ', '$apellido']
    ...
    const libros = yield libro_1.default.find({
        $or: [
            {
                nombre: termino
            },
...
const obtenerLibro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const libro = yield libro_1.default.findById(id).populate('autores', ['nombre', 'apellido']);
    res.json({
        ok: true,
        data: libro
    });
